...
class MyNotes {
    constructor() {
        if (document.querySelector("#my-notes")) {
            axios.defaults.headers.common["X-WP-Nonce"] = FictionalUniversityData.nonce
    ...
    async createNote() {
        ...
        try {
            const response = await axios.post(FictionalUniversityData.rootUrl + "/wp-json/wp/v2/note/", ourNewPost)
    ...
    async updateNote(e) {
        ...
        try {
            const response = await axios.post(FictionalUniversityData.rootUrl + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), ourUpdatedPost)
            this.makeNoteReadOnly(thisNote)
        } catch (e) {
            console.log("Sorry")
        }
    ...
    async deleteNote(e) {
        ...
        try {
            const response = await axios.delete(FictionalUniversityData.rootUrl + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"))

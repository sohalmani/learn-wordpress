...
class MyNotes {
  ...
  bindEvents() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.create-note').on('click', '.submit-note', this.createNote.bind(this));
  ...
  createNote(e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      data: {
        'title': jquery__WEBPACK_IMPORTED_MODULE_0___default()('.create-note').find('.new-note-title').val(),
        'content': jquery__WEBPACK_IMPORTED_MODULE_0___default()('.create-note').find('.new-note-body').val(),
        'status': 'publish'
      }
    }).done(response => {
